...
-(void)performSegueToCorrect{
    if(SEGUES_ENABLED){
        @try {
            [_ROSController publishViewFlow:@"Going to Correct..."];
...
-(void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender{
    ...
    [_ROSController publishFacialRecogntionMessage:_facialRecognitionMessage];
    ...
    if([segue.identifier isEqualToString:@"toCorrect"]){
        ...
        controller.photoTakenByKairos = photoTakenByKairos;
