...
@property(nonatomic, retain)RosViewController *viewController;
 ...
 * \param message the type of message ROS is expecting
...
-(void)managerAlreadyConnected:(RBManager*)manager;
