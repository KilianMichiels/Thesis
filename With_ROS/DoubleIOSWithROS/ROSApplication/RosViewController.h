...
@interface RosViewController : UIViewController <UITextFieldDelegate, CLLocationManagerDelegate, MainROSControlDelegate, CvVideoCameraDelegate>{
...
@property (strong, nonatomic) IBOutlet UILabel *numberOfMessagesReceived;
