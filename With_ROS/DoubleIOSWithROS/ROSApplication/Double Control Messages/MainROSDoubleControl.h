...
@property RBSubscriber * frameRateSubscriber;

@property RBSubscriber * speedSubscriber;
...
/*!
 Listen to changes of the camera frame rate.
 */
- (BOOL)subscribeToFrameRate;

/*!
 Listen to changes of speed of the Double.
 */
